...
def test_gamut(task=None, net=None, batch=None,
               ...
               include_metric=True, metric_select_tau=[0, 0.01, 1, 10, 25, 49.9], metric_n_samples=3, metric_alpha=0.01, metric_d_theta=1e-6, metric_order=3, metric_dtype=torch.float64, metric_n_instantiations=30, metric_norm_dphi=True,
