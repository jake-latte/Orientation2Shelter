...
from typing import Callable, Tuple, Self, Any
...
class Task:
    ...
    Receives
        ...
        create_data_func :
            Function for generating data for task
        input_map :
    ...
    def __init__(self, 
                 ...
                 create_data_func: Callable[[Self, RNN, dict], dict],
                 input_map: dict, 
                 target_map:dict, 
                 loss_func: Callable[[Self, RNN, dict], Tuple[torch.Tensor, torch.Tensor]] = None, 
                 test_func: Callable[[Self, RNN, dict], dict] = None, 
                 test_func_args:dict = {}, 
    ...
    @classmethod
    def from_checkpoint(self, checkpoint: dict) -> Self:
