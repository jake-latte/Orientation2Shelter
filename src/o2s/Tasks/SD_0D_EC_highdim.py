...
class SD_0D_EC_highdim(template_0D.Vars0D, template_EC.VarsEC, template_highdim.VarsHighdim):
    task_name = "SD-0D-EC_highdim"
    input_map = {
        'av': 0
    }
    target_map = {
    ...
    def create_data(config, vars, inputs, targets, mask):
        ...
        inputs[:,:,SD_0D_EC_highdim.input_map['av']] = vars['av']
